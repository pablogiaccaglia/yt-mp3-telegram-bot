...
if __name__ == '__main__':
    stri = "--audio sfera-ebbasta-sciroppo-ft-drefgold-prod-charlie-charles-daves-the-kid-ft-drefgold.wav --output sfera-ebbasta-sciroppo-ft-drefgold-prod-charlie-charles-daves-the-kid-ft-drefgold-vaporised.mp3"
    edit(stri)